...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2019 a las 17:00:59
...
CREATE TABLE `rol_entidad` (
  `ROLENT_ID` int(11) NOT NULL,
  `ROLENT_DESCRIPCION` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `entidad`
  MODIFY `ENTIDA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `rol_entidad`
  MODIFY `ROLENT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
