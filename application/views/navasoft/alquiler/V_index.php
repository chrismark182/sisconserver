...
<nav class="blue-grey lighten-1" style="padding: 0 1em;">
    <div class="nav-wrapper">
        <div class="col s4" style="display: inline-block">
            <a href="#!" class="breadcrumb">Traslado a Navasoft - Valorizaciones</a>
        </div>
...
<div class="section container center" style="padding-top: 0px">
    <div class="row" style="margin-bottom: 0px">
        <form action="<?= base_url() ?>navasoft_alquiler" method="post">
...
<script>
    ...
    function buscar()
    {
        ...
        var url = 'navasoft_alquiler/buscar';
    ...
    function generar_dbf(empresa,liquidacion){
        ...
        .then(function(data) 
        {
            ...
            $('.preloader-background').css({'display': 'none'});
            window.location.href = "<?= base_url() ?>navasoft_alquiler?li=" + liquidacion;
        });
    }
